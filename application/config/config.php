...
|
*/
if (strpos($_SERVER['HTTP_HOST'], 'localhost') !== false || strpos($_SERVER['HTTP_HOST'], '127.0.0.1') !== false || strpos($_SERVER['HTTP_HOST'], '.test')) {
...
|
' page of the user guide for information regarding date handling.
|
*/
